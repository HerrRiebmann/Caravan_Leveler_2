 ...
 *  @file MPU6050.h
 *
 *  Custom I2C Driver for MPU6050 6-DoF Accelerometer and Gyro
 *  Based on Custom_MPU6050 library by Bryan Siepert
 *  Modified to accept compatible device IDs (MPU6500, MPU9250, clones, etc.)
 *
 *  Original library: https://www.adafruit.com/products/3886
 */

/*!
 *  @file Custom_MPU6050.h
 *
...
#ifndef _CUSTOM_MPU6050_H
#define _CUSTOM_MPU6050_H
...
class Custom_MPU6050_Gyro : public Adafruit_Sensor {
public:
  /** @brief Create an Adafruit_Sensor compatible object for the gyro sensor
      @param parent A pointer to the MPU6050 class */
  Custom_MPU6050_Gyro(Custom_MPU6050 *parent) { _theMPU6050 = parent; }
  bool getEvent(sensors_event_t *);
  void getSensor(sensor_t *);
...
protected:
  ...
  Custom_MPU6050_Temp *temp_sensor = NULL; ///< Temp sensor data object
  Custom_MPU6050_Accelerometer *accel_sensor =
      NULL;                                  ///< Accelerometer data object
  Custom_MPU6050_Gyro *gyro_sensor = NULL; ///< Gyro data object
...
private:
  friend class Custom_MPU6050_Temp; ///< Gives access to private members to
                                      ///< Temp data object
  friend class Custom_MPU6050_Accelerometer; ///< Gives access to private
                                               ///< members to Accelerometer
                                               ///< data object
  friend class Custom_MPU6050_Gyro; ///< Gives access to private members to
                                      ///< Gyro data object
